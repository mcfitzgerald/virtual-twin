...
from virtual_twin.models import MachineConfig, MaterialType, Product, ProductConfig
from virtual_twin.simulation.layout import LayoutBuilder
...
class SimulationEngine:
    ...
    def run_resolved(
        ...
        if self.save_to_db:
            from virtual_twin.storage import save_results
