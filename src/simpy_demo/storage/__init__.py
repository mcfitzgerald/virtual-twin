...
Example usage:
    from simpy_demo.storage import save_results, connect
...
DEFAULT_DB_PATH = Path("./simpy_results.duckdb")
...
def save_results(
    ...
    Args:
        ...
        db_path: Path to database file (default: ./simpy_results.duckdb)
