...
class ScenarioGenerator:
    ...
    def __init__(self, config_dir: str = "config"):
        ...
        try:
            self.jinja_env = Environment(
                loader=PackageLoader("virtual_twin.codegen", "templates"),
                trim_blocks=True,
                lstrip_blocks=True,
            )
        except Exception:
    ...
    def generate_bundle(
        ...
        with open(snapshot_path, "w") as f:
            ...
            f.write(
                ...
                f"python -m virtual_twin configure --run {resolved.run.name}\n\n"
            )
    ...
    def _create_metadata(
        ...
        metadata: Dict[str, Any] = {
            ...
            "cli_command": f"python -m virtual_twin configure --run {resolved.run.name}",
            "virtual_twin_version": self._get_version(),
...
'''
    ...
    def _get_version(self) -> str:
        """Get virtual-twin version."""
        try:
            from importlib.metadata import version

            return version("virtual-twin")
        except Exception:
            return "unknown"
